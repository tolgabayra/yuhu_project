...
export default function index() {
  ...
  return (
    <div>
      <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex border-gray-300 flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
          <div className="-mx-6 px-6 py-4">
            <a className='font-bold' href="#" title="home">
              Your Home Page
            </a>
          </div>
      ...
      <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
          <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
            ...
            <p className='bg-red-500 text-white p-1 rounded-xl pr-3 pl-3 hover:cursor-pointer'>Log out</p>
          </div>
        </div>
        ...
        <div className="px-6 pt-6 2xl:container">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="md:col-span-2 lg:col-span-1" >
              <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-300 bg-white">
            ...
            <div>
              <Card border="1px" borderColor="gray.300" borderRadius="xl" maxW="xl">
                <CardHeader>
                  <Flex spacing='4'>
            ...
            <div>
              <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-300 bg-white">
